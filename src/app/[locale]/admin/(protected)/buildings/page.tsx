              ...
              <TableRow key={b.id}>
                <TableCell>
                  {b.prymary_image ? (
                    ...
                    <div className='h-10 w-10 rounded-md bg-default-100' />
                  )}
                </TableCell>
                <TableCell>
            ...
            <CardBody className='space-y-3'>
              <div className='flex items-start gap-3'>
                {b.prymary_image ? (
                  ...
                  <div className='h-14 w-14 shrink-0 rounded-md bg-default-100' />
                )}
                      ...
                      <div className='rounded-lg border border-default-200 p-2'>
                        ...
                        <div className='relative'>
                          {editingBuilding?.prymary_image ? (
                            <div className='relative h-24 w-full overflow-hidden rounded-md border border-default-200 bg-default-100 sm:h-28'>
                              <Image
                                src={
                                  selectedPrimaryPreviewUrl ||
                                  editingBuilding.prymary_image
                        ...
                        <div className='space-y-2 rounded-md border border-primary/30 bg-primary/5 p-2'>
                          ...
                          <div className='grid grid-cols-3 gap-2 sm:grid-cols-4 md:grid-cols-6'>
                            {selectedBatchPreviewUrls.map((url, idx) => (
                              <div
                                key={`${url}-${idx}`}
                                className='relative h-14 w-full overflow-hidden rounded-md border border-default-200 bg-default-100'
                              >
                                <Image
                                  src={url}
                      ...
                      {currentGalleryImages.length > 0 ? (
                        <div className='grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5'>
                          {currentGalleryImages.map((url, idx) => (
                            <div
                              key={`${url}-${idx}`}
                              className='relative h-14 w-full overflow-hidden rounded-md border border-default-200 bg-default-100 sm:h-16'
                            >
                              <Image
                                src={url}
