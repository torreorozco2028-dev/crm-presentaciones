                          ...
                          {images.length > 0 ? (
                            <div className='flex gap-1'>
                              {images.slice(0, 4).map((img, idx) => (
                                <div
                                  key={idx}
                                  className='relative h-9 w-9 shrink-0 overflow-hidden rounded-md border border-default-200'
                                >
                                  <Image
                                    src={img}
                                    alt={`foto ${idx + 1}`}
                        ...
                        {images.length > 0 ? (
                          <div className='flex gap-1'>
                            {images.slice(0, 4).map((img, idx) => (
                              <div
                                key={idx}
                                className='relative h-10 w-10 shrink-0 overflow-hidden rounded-md border border-default-200'
                              >
                                <Image
                                  src={img}
                                  alt={`foto ${idx + 1}`}
                  ...
                  <div className='mb-3'>
                    ...
                    <div className='grid grid-cols-3 gap-2 sm:grid-cols-4 md:grid-cols-5'>
                      {currentGalleryImages.map((url, idx) => (
                        <div
                          key={`${url}-${idx}`}
                          className='relative h-16 w-full overflow-hidden rounded-md border border-default-200'
                        >
                          <Image
                            src={url}
                            alt={`Foto ${idx + 1}`}
